 ...
 * Message Pack specification: <https://github.com/msgpack/msgpack/blob/main/spec.md>
...
supports all of the message pack types, including [extension format](https://github.com/msgpack/msgpack/blob/main/spec.md#formats-ext).
