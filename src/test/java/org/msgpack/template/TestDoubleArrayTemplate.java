...
public class TestDoubleArrayTemplate {
	...
	new TestStreamPackStreamUnpack(0).testDoubleArray();
    }

    @Test
    public void testStreamPackStreamUnpack01() throws Exception {
	new TestStreamPackStreamUnpack(1).testDoubleArray();
    }

    @Test
    public void testStreamPackStreamUnpack02() throws Exception {
	new TestStreamPackStreamUnpack(2).testDoubleArray();
    }

    @Test
    public void testStreamPackBufferUnpack00() throws Exception {
	new TestStreamPackBufferUnpack(0).testDoubleArray();
    }

    @Test
    public void testStreamPackBufferUnpack01() throws Exception {
	new TestStreamPackBufferUnpack(1).testDoubleArray();
    }

    @Test
    public void testStreamPackBufferUnpack02() throws Exception {
	new TestStreamPackBufferUnpack(2).testDoubleArray();
    }
	...
	new TestBufferPackStreamUnpack(0).testDoubleArray();
    }

    @Test
    public void testBufferPackStreamUnpack01() throws Exception {
	new TestBufferPackStreamUnpack(1).testDoubleArray();
    }

    @Test
    public void testBufferPackStreamUnpack02() throws Exception {
	new TestBufferPackStreamUnpack(2).testDoubleArray();
    }
	...
	public void testDoubleArray(double[] v) throws Exception {
	    Template tmpl = DoubleArrayTemplate.instance;
	    ...
	    double[] ret = (double[]) tmpl.read(unpacker, ret0);
