...
public class TestTemplatePreCompilerBufferPackBufferUnpack extends TestSet {
	...
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), PrimitiveTypeFieldsClass.class);
	    Template<PrimitiveTypeFieldsClass> tmpl = msgpack.lookup(PrimitiveTypeFieldsClass.class);
	    ...
	    TemplatePrecompiler.deleteTemplateClass(PrimitiveTypeFieldsClass.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), PrimitiveTypeFieldsClassNotNullable.class);
	    Template<PrimitiveTypeFieldsClassNotNullable> tmpl = msgpack.lookup(PrimitiveTypeFieldsClassNotNullable.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(PrimitiveTypeFieldsClassNotNullable.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), ReferenceTypeFieldsClass.class);
	    Template<ReferenceTypeFieldsClass> tmpl = msgpack.lookup(ReferenceTypeFieldsClass.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(ReferenceTypeFieldsClass.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), ReferenceTypeFieldsClassNotNullable.class);
	    Template<ReferenceTypeFieldsClassNotNullable> tmpl = msgpack.lookup(ReferenceTypeFieldsClassNotNullable.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(ReferenceTypeFieldsClassNotNullable.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), ListTypeFieldsClass.class);
	    Template<ListTypeFieldsClass> tmpl = msgpack.lookup(ListTypeFieldsClass.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), ListTypeFieldsClassNotNullable.class);
	    Template<ListTypeFieldsClassNotNullable> tmpl = msgpack.lookup(ListTypeFieldsClassNotNullable.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(ListTypeFieldsClassNotNullable.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), MapTypeFieldsClass.class);
	    Template<MapTypeFieldsClass> tmpl = msgpack.lookup(MapTypeFieldsClass.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), MapTypeFieldsClassNotNullable.class);
	    Template<MapTypeFieldsClassNotNullable> tmpl = msgpack.lookup(MapTypeFieldsClassNotNullable.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(MapTypeFieldsClassNotNullable.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), FinalClass.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), ModifiersFieldsClass.class);
	    Template<ModifiersFieldsClass> tmpl = msgpack.lookup(ModifiersFieldsClass.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), ModifiersFieldsClassNotNullable.class);
	    Template<ModifiersFieldsClassNotNullable> tmpl = msgpack.lookup(ModifiersFieldsClassNotNullable.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(ModifiersFieldsClassNotNullable.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), UserDefinedTypeFieldsClass.class);
	    Template<UserDefinedTypeFieldsClass> tmpl = msgpack.lookup(UserDefinedTypeFieldsClass.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(UserDefinedTypeFieldsClass.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), UserDefinedTypeFieldsClassNotNullable.class);
	    Template<UserDefinedTypeFieldsClassNotNullable> tmpl = msgpack.lookup(UserDefinedTypeFieldsClassNotNullable.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(UserDefinedTypeFieldsClassNotNullable.class);
	    msgpack.unregister(UserDefinedTypeFieldsClassNotNullable.class);
	}
    }

    @org.junit.Ignore @Test @Override // FIXME #MN next version 
    public void testReferenceCycleTypeFieldsClass() throws Exception {
	super.testReferenceCycleTypeFieldsClass();
    }

    @org.junit.Ignore @Override // FIXME #MN next version 
    public void testReferenceCycleTypeFieldsClass(ReferenceCycleTypeFieldsClass v) throws Exception {
	System.getProperties().setProperty(TemplatePrecompiler.DEST, "./target/test-classes");
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), ReferenceCycleTypeFieldsClass.class);
	    Template<ReferenceCycleTypeFieldsClass> tmpl = msgpack.lookup(ReferenceCycleTypeFieldsClass.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), ReferenceCycleTypeFieldsClassNotNullable.class);
	    Template<ReferenceCycleTypeFieldsClassNotNullable> tmpl = msgpack.lookup(ReferenceCycleTypeFieldsClassNotNullable.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(ReferenceCycleTypeFieldsClassNotNullable.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), InheritanceClassNotNullable.class);
	    Template<InheritanceClassNotNullable> tmpl = msgpack.lookup(InheritanceClassNotNullable.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(InheritanceClassNotNullable.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), MessagePackableTypeFieldsClass.class);
	    Template<MessagePackableTypeFieldsClass> tmpl = msgpack.lookup(MessagePackableTypeFieldsClass.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(MessagePackableTypeFieldsClass.class);
	...
	MessagePack msgpack = new MessagePack();
	try {
	    TemplatePrecompiler.saveTemplateClass(new TemplateRegistry(null), MessagePackableTypeFieldsClassNotNullable.class);
	    Template<MessagePackableTypeFieldsClassNotNullable> tmpl = msgpack.lookup(MessagePackableTypeFieldsClassNotNullable.class);
	    BufferPacker packer = msgpack.createBufferPacker();
	    tmpl.write(packer, v);
	    byte[] bytes = packer.toByteArray();
	    BufferUnpacker unpacker = msgpack.createBufferUnpacker();
	    ...
	    TemplatePrecompiler.deleteTemplateClass(MessagePackableTypeFieldsClassNotNullable.class);
