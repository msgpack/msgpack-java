...
import org.msgpack.value.AbstractMapValue;
import org.msgpack.packer.Packer;

public class ArrayMapValueImpl extends AbstractMapValue {
    private static ArrayMapValueImpl emptyInstance = new ArrayMapValueImpl(new Value[0], true);
    ...
    ArrayMapValueImpl(Value[] array, boolean gift) {
        if (array.length % 2 != 0) {
    ...
    // private boolean equals(ArrayMapValueImpl o) {
