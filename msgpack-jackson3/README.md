...
**Requirements:** Java 17+ and Jackson 3.x. This is a new artifact published under the `org.msgpack.jackson3` groupId. For the Jackson 2.x compatible version, see [`org.msgpack:jackson-dataformat-msgpack`](../msgpack-jackson/).
...
```xml
<dependency>
  <groupId>org.msgpack.jackson3</groupId>
...
```scala
libraryDependencies += "org.msgpack.jackson3" % "jackson-dataformat-msgpack" % "(version)"
```
...
dependencies {
    implementation 'org.msgpack.jackson3:jackson-dataformat-msgpack:(version)'
}
```
